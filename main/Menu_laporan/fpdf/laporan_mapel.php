...
$pdf->Cell('C', 7, 'LIST DATA MAPEL', 0, 1, 'C');
...
$pdf->Cell(20, 13, '  ID Mapel', 1, 0);
$pdf->Cell(35, 13, '  Nama ', 1, 0);
$pdf->Cell(45, 13, '  Kurikulum', 1, 0);
$pdf->Cell(23, 13, '  KKM', 1, 0);
...
while ($data = mysqli_fetch_array($query)) {
	...
	$pdf->Cell(20, 7, $data['id_mapel'], 1, 0);
	$pdf->Cell(35, 7, $data['nama'], 1, 0);
	$pdf->Cell(45, 7, $data['kurikulum'], 1, 0);
	$pdf->Cell(23, 7, $data['kkm'], 1, 0);
