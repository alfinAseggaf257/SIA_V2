...
$pdf->Cell('C', 7, 'LIST DATA DIRI GURU', 0, 1, 'C');
$pdf->Cell('C', 7,  'Tahun Ajaran ' . (date('Y')) . '/' . (date('Y') + 1), 0, 0, 'C');
$pdf->Cell(10, 10, '', 0, 1);
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(13, 13, '  No.', 1, 0);
$pdf->Cell(16, 13, '  NIP', 1, 0);
$pdf->Cell(35, 13, '  Nama ', 1, 0);
$pdf->Cell(43, 13, '  Alamat', 1, 0);
$pdf->Cell(29, 13, '  Jenis Kelamin', 1, 0);
$pdf->Cell(25, 13, '  Jabatan', 1, 0);
$pdf->Cell(30, 13, '  Nomor Telp', 1, 1);
...
while ($data = mysqli_fetch_array($query)) {
	...
	$pdf->Cell(16, 7, $data['nip'], 1, 0);
	$pdf->Cell(35, 7, $data['nama'], 1, 0);
	$pdf->Cell(43, 7, $data['alamat'], 1, 0);
	$pdf->Cell(29, 7, $data['jenis_kelamin'], 1, 0);
	$pdf->Cell(25, 7, $data['jabatan'], 1, 0);
	$pdf->Cell(30, 7, $data['telp'], 1, 1);
